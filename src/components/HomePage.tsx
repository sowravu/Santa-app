...
import SantaMaze from './SantaMaze';
...
const HomePage: React.FC = () => {
    ...
    return (
        <div className="w-full flex flex-col gap-16 pb-12">
            {/* Hero Section */}
            <div className="w-full max-w-7xl mx-auto px-6 md:px-12 pt-6 md:pt-8 flex flex-col md:flex-row items-center md:items-start justify-between gap-8 md:gap-16 animate-fadeIn min-h-[80vh]">
                {/* Left Content */}
                ...
                <div className="flex-1 flex justify-center md:justify-end z-10 w-full h-full relative">
                    <div className="relative w-full h-full flex items-center justify-center transform hover:scale-105 transition-transform duration-500">
                        <img
                            ...
                            className="object-contain max-h-[70vh] w-auto drop-shadow-2xl mix-blend-lighten relative z-10"
                        />
            ...
            {/* Coloring Section */}
            {/* Coloring Section */}
            <div id="coloring" className="scroll-mt-32">
                <ColoringSection />
            </div>

            {/* Maze Game Section */}
            <div id="maze" className="scroll-mt-32">
                <SantaMaze />
            </div>
        </div>
    );
